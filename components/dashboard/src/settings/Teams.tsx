    ...
    const renderTeams = () => (<React.Fragment>
        <div className="flex flex-row">
            <div className="flex-grow ">
                <h3 className="self-center">所有团队</h3>
                <h2>管理团队和团队成员.</h2>
            </div>
        ...
        {(getActiveSubs().length === 0 && !pendingPlanPurchase) && (
            <div className="w-full flex h-80 mt-2 rounded-xl bg-gray-100 dark:bg-gray-900">
                <div className="m-auto text-center">
                    <h3 className="self-center text-gray-500 dark:text-gray-400 mb-4">没有活跃的团队</h3>
                    <div className="text-gray-500 mb-6">从创建团队开始<br />以及增加团队成员
                    {/* <a href="https://www.gitpod.io/docs/teams/" target="_blank" rel="noopener" className="text-gray-400 learn-more hover:text-gray-600">了解更多</a> */}
                    </div>
                    <button className="self-center" onClick={() => showCreateTeamModal()}>创建团队</button>
                </div>
            </div>
        )}
...
function NewTeamModal(props: {
    ...
    return (<Modal visible={true} onClose={props.onClose}>
        <h3 className="pb-2">新建团队</h3>
        <div className="border-t border-b border-gray-200 dark:border-gray-800 mt-2 -mx-6 px-6 py-4 space-y-2">
            <p className="pb-4 text-gray-500 text-base">创建团队并添加团队成员</p>

            <div className="flex flex-col space-y-2">
                <label htmlFor="type" className="font-medium">团队</label>
