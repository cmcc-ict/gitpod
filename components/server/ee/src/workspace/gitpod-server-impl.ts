...
import { LicenseValidationResult, GetLicenseInfoResult, LicenseFeature } from 'cmict-gitpod-protocol/lib/license-protocol';
import { PrebuildManager } from "../prebuilds/prebuild-manager";
import { LicenseDB } from "cmict-gitpod-db/lib";
...
import { AccountStatement, CreditAlert, Subscription } from "cmict-gitpod-protocol/lib/accounting-protocol";
import { EligibilityService } from "../user/eligibility-service";
import { AccountStatementProvider } from "../user/account-statement-provider";
import { GithubUpgradeURL, PlanCoupon } from "cmict-gitpod-protocol/lib/payment-protocol";
import { AssigneeIdentityIdentifier, TeamSubscription, TeamSubscriptionSlot, TeamSubscriptionSlotResolved } from "cmict-gitpod-protocol/lib/team-subscription-protocol";
...
import { AccountingDB, TeamSubscriptionDB, EduEmailDomainDB } from "cmict-gitpod-db/lib";
